...
import static it.eng.parer.tipidato.abilitati.beans.utils.Costants.URL_API_VERS;
import it.eng.parer.tipidato.abilitati.runner.rest.input.VersParamQuery;
...
@Tag(name = "Lista tipi dato abilitati", description = "Api che restituisce la lista dei tipi dato abilitati per versatore")
@SecurityScheme(securitySchemeName = "bearerAuth", type = SecuritySchemeType.HTTP, scheme = "bearer")
@RequestScoped
@Path(URL_API_VERS)
public class VersTipiDatoAbilitatiEndpoint {
